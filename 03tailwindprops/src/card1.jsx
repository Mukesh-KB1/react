...
export default function Card1({btnText = "Learn More",Uname="Unknown man",description,view="1000"}) {
    console.log(Uname);
    console.log(btnText);
    
    
  return (
    <div className="my-4 md:max-w-sm w-full p-6 rounded-xl shadow-xl bg-black border border-zinc-800 hover:border-white transition-all duration-300 hover:transform hover:scale-105 group">
